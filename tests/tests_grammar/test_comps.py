...
def test_is_lower_than(pseutopy):
    ...
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[0])
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[1])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[2])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[3])
    assert pseutopy.convert_to_ast(python_code[2]) == pseutopy.convert_to_ast(pseutopy_code[4])
    assert pseutopy.convert_to_ast(python_code[2]) == pseutopy.convert_to_ast(pseutopy_code[5])
...
def test_is_greater_or_equal_to(pseutopy):
    ...
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[0])
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[1])
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[2])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[3])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[4])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[5])

def test_in(pseutopy):
    python_code = ['2 in range(4)', '3 in range(len(tab))']
    pseutopy_code = ['2 in range(4)', '3 in range(len(tab))']
    assert pseutopy.convert_to_ast(python_code[0]) == pseutopy.convert_to_ast(pseutopy_code[0])
    assert pseutopy.convert_to_ast(python_code[1]) == pseutopy.convert_to_ast(pseutopy_code[1])
